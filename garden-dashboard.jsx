...
const plants = [
  {
    ...
    hasSensor: true, moisture: 68, temp: 24.5, light: "medium",
    lastWatered: "2h ago", status: "happy", hp: 92,
    history: [45, 52, 60, 68, 72, 70, 68],
  },
  {
    id: 2, name: "Suculenta", species: "Echeveria elegans", emoji: "🪴",
    hasSensor: true, moisture: 32, temp: 26.1, light: "high",
    lastWatered: "3d ago", status: "thirsty", hp: 58,
    history: [80, 72, 60, 50, 42, 36, 32],
  },
  {
    id: 3, name: "Samambaia", species: "Nephrolepis exaltata", emoji: "🌱",
    hasSensor: true, moisture: 85, temp: 22.3, light: "low",
    lastWatered: "6h ago", status: "happy", hp: 95,
  ...
  },
  {
    ...
    lastWatered: "5d ago", status: "unknown", hp: null,
    history: [],
  },
  {
    id: 5, name: "Monstera", species: "Monstera deliciosa", emoji: "🍃",
    hasSensor: true, moisture: 55, temp: 23.8, light: "medium",
    lastWatered: "1d ago", status: "happy", hp: 78,
    history: [70, 68, 64, 60, 58, 56, 55],
  },
  {
    id: 6, name: "Cacto", species: "Cereus jamacaru", emoji: "🌵",
    hasSensor: false, moisture: null, temp: null, light: null,
    lastWatered: "2w ago", status: "unknown", hp: null,
    history: [],
  },
];
...
function MiniChart({ data, width = 80, height = 28 }) {
  ...
  return (
    <svg width={width} height={height} style={{ display: "block" }}>
      <defs>
        <linearGradient id={`cf-${width}`} x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor={COLORS.primary} stopOpacity="0.2" />
          <stop offset="100%" stopColor={COLORS.primary} stopOpacity="0.02" />
        </linearGradient>
      </defs>
      <path d={areaPath} fill={`url(#cf-${width})`} />
      <polyline
  ...
  return (
    <div style={{
      ...
      <div style={{ display: "flex", gap: 6 }}>
        {[
          { label: "💧 WATER", bg: COLORS.waterPale, color: COLORS.waterDark, hoverBg: COLORS.water },
          { label: "📝 LOG", bg: COLORS.primaryPale, color: COLORS.primaryDark, hoverBg: COLORS.primary },
          { label: "⚙ EDIT", bg: COLORS.bg, color: COLORS.textMid, hoverBg: COLORS.brownLight },
        ].map(btn => (
          <button key={btn.label} style={{
            ...
            onMouseEnter={e => { e.currentTarget.style.background = btn.hoverBg; e.currentTarget.style.color = COLORS.white; }}
    ...
    <div style={{
      ...
      <style>{`
        ...
        *{box-sizing:border-box} body{margin:0}
        ...
        @media(min-width:820px){.detail-mobile-overlay{display:none!important}}
      `}</style>
