...
const demoPlants = [
  ...
  { id: '2', name: 'Suculenta', species: 'Echeveria elegans', emoji: '\uD83E\uDEB4', status: 'thirsty' as const, hp: 58, moisture: 31, temp: 26.1, lightLabel: 'high', lastWatered: '2026-03-10T08:00:00Z' },
